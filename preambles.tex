...
% Global chapter wrapper to automatically uppercase chapter names in the TOC.
\makeatletter
\let\origchapter\chapter
\def\chapter{%
	\@ifstar{\@mycstarred}{\@mycunstarred}%
}
\def\@mycstarred#1{\origchapter*{#1}}
\def\@mycunstarred{\@ifnextchar[{\@mycopt}{\@mycnoopt}}
\def\@mycopt[#1]#2{\origchapter[\MakeUppercase{#1}]{#2}}
\def\@mycnoopt#1{\origchapter[\MakeUppercase{#1}]{#1}}
\makeatother
...
% To set the subsubsection headings
...
\newenvironment{thesisappendices}{
	...
	\addtocontents{toc}{\protect\setlength{\protect\cftchapindent}{2em}} 
	\addtocontents{toc}{\protect\addtolength{\protect\cftchapnumwidth}{1.5em}}
	\begin{appendices}
...
\setlength{\cftsubparaindent}{8em}
